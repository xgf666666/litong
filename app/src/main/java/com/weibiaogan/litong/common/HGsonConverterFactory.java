...
import static com.weibiaogan.litong.common.Constants.SHORT_TOKEN_INVALID;
import static com.weibiaogan.litong.common.Constants.SHORT_TOKEN_INVALID_;
...
//                }
                else if (SHORT_TOKEN_INVALID.equals(baseResponseEntity.getCode()) || SHORT_TOKEN_INVALID_.equals(baseResponseEntity.getCode())||"40004".equals(baseResponseEntity.getCode())) {
                    //短token过期,刷新token
